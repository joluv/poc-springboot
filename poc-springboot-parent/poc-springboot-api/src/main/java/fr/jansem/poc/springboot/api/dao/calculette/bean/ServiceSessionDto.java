...
/**
 * <p>Classe Java pour serviceSessionDto complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="serviceSessionDto"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "serviceSessionDto", propOrder = {
    "applicationId",
    "attributeList",
    "companyId",
    "language",
...
public class ServiceSessionDto {
    ...
    protected ServiceSessionDto.AttributeList attributeList;
     ...
     * @return
     *     possible object is
     *     {@link ServiceSessionDto.AttributeList }
     *     
     */
    public ServiceSessionDto.AttributeList getAttributeList() {
     ...
     *     
     */
    public void setAttributeList(ServiceSessionDto.AttributeList value) {
    ...
    public static class AttributeList {
        ...
        protected List<ServiceSessionDto.AttributeList.Entry> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ServiceSessionDto.AttributeList.Entry }
         * 
         * 
         */
        public List<ServiceSessionDto.AttributeList.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<ServiceSessionDto.AttributeList.Entry>();
            }
            return this.entry;
        }
